...
def train(model_name, params):
    if model_name == backend.models[0]:
        ...
        st.success('Done!')
    elif model_name in backend.models[1:]:
        # Train other models
...
# KNN model
    ...
    n_neighbors = st.sidebar.slider('Number of Neighbors',
